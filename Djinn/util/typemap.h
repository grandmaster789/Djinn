...
namespace djinn::util {
	...
	public:
		...
		void remove(
		    T* ptr
		    = nullptr);  // interestingly, the value of the argument is optional here; this syntax allows both
		    // explicit templates without a parameter and argument type deduction for the template type
